...
<html>
    ...
    <center>
        <div id="a4">
            ...
            <hr class="line1">
            <div id="sub-header">
                <h3> Status wise Restaurant Details</h3>
            </div>
            <div id="filter">
                <?php {
                    ...
                    echo "<option value='0'>Blocked</option>";
                    echo "</select> ";
            ...
            if ($_POST) {
                ...
                $status = $_POST['status'];
                $query = "select * from restaurant_detail r,locality l,city c,state s where  r.locality_id=l.locality_id and r.city_id=c.city_id and c.state_id=s.state_id and s.state_id='{$state_id}' and c.city_id='{$city_id}' and r.rest_status='{$status}'";
                $result = mysql_query($query) or die(mysql_error());
