        ...
        <div class="container-fluid">
          ...
          <div class="row-fluid">
            ...
            <div class="span12 widget dark stacked">
              <header>
                <h4 class="title pull-left"><span class="icon icone-user"></span>States</h4>
                <!-- START Button Group -->
                <div class="btn-group pull-right">
                    <a class="btn" href="state-add.php">New State</a>
                ...
                <div class="body-inner no-padding">
                  <table class="table table-bordered table-striped table-hover " id="datatable1" name="statetable">
                    ...
                    <tbody>
                      ...
                      . "<td>{$row['state_id']}"
                        . "<td>{$row['state_name']}"
                           . "<td><a href='state-edit.php?qry={$row['state_id']}' class='btn1 btn1-violate'><span class='icone-edit'></span> Edit</a>&nbsp"
                          . "<a href='state-delete.php?qry={$row['state_id']}' class='btn1 btn1-red'><span class='icone-trash'></span> Delete</a>"
                          . "</tr>";
                      }
                      ?>
                    </tbody>
