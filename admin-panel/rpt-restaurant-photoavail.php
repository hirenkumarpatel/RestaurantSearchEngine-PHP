...
<html>
    ...
    <center>
        <div id="a4">
            ...
            <hr class="line1">
            <div id="sub-header">
                <h3> Photo wise Restaurant Details</h3>
            </div>
            <div id="filter">
                <?php {
                    ...
                    echo "<select name='photo_avail'>";
                    echo "<option value=''>Photo Availability</option>";
            ...
            if ($_POST) {
                ...
                if($photo_avail==1)
                {
                    $query = "select * from restaurant_detail r,locality l,city c,state s where  r.locality_id=l.locality_id and r.city_id=c.city_id and c.state_id=s.state_id and s.state_id='{$state_id}' and c.city_id='{$city_id}' and r.rest_id in(
                        select r.rest_id from restaurant_detail r,restaurant_photo rp where rp.rest_id=r.rest_id group by rp.rest_id)";
                    $photo_avail="Available";
                }
                else
                {
