...
?>
            ...
            <!--Banner End-->
<?php
$query = "select * from restaurant_detail r,foodie_wish_list wl,locality l,city c 
                ...
                <div class="container">
                    ...
                    <div class="grid_10 column alpha pos-relative">
                        ...
                        <div class="even mbot0 ptop0">
                            <div class="plr15"><h2 class="section-heading mb0">Wishlist <span class="grey-text"><?php echo $record; ?></span></h2></div>
                                    ...
                                    <div class='grid_6 mbot0'><div class='actn'>
                                            ...
                                            <div class='actn-data'>
                                                ...
                                                <div class='actn-data-r '>
                                                    ...
                                                    <div style='margin-left:20px;'><a href='foodie-wishlist-delete.php?qry={$rest_id}' title='Remove from wishlist'><span class='icon-trash' style='font-size:35px;color:#2d2d2d;text-decoration:none;'></span></a></div>
